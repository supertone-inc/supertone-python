...
with Supertone(
    ...
    res = s_client.text_to_speech.stream_speech(voice_id="<id>", text="<value>", language=models.APIConvertTextToSpeechUsingCharacterRequestLanguage.PT, model="sona_speech_1", output_format=models.APIConvertTextToSpeechUsingCharacterRequestOutputFormat.WAV, include_phonemes=False)
...
with Supertone(
    ...
    res = s_client.text_to_speech.predict_duration(voice_id="<id>", text="<value>", language=models.PredictTTSDurationUsingCharacterRequestLanguage.JA, model="sona_speech_1", output_format=models.PredictTTSDurationUsingCharacterRequestOutputFormat.WAV)
