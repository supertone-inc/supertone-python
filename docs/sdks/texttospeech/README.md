...
| `normalized_text`                                                                                                                                   | *Optional[str]*                                                                                                                                     | :heavy_minus_sign:                                                                                                                                  | Pre-normalized text for TTS. Only used with sona_speech_2 and sona_speech_2_flash models.                                                           |
...
with Supertone(
    ...
    res = s_client.text_to_speech.predict_duration(voice_id="<id>", text="<value>", language=models.PredictTTSDurationRequestLanguage.JA, model=models.PredictTTSDurationRequestModel.SONA_SPEECH_1, output_format=models.PredictTTSDurationRequestOutputFormat.WAV)
...
| `style`                                                                                                         | *Optional[str]*                                                                                                 | :heavy_minus_sign:                                                                                              | The style of character to use for the text-to-speech conversion                                                 |
| `model`                                                                                                         | [Optional[models.PredictTTSDurationRequestModel]](../../models/predictttsdurationrequestmodel.md)               | :heavy_minus_sign:                                                                                              | The model type to use for the text-to-speech conversion                                                         |
| `output_format`                                                                                                 | [Optional[models.PredictTTSDurationRequestOutputFormat]](../../models/predictttsdurationrequestoutputformat.md) | :heavy_minus_sign:                                                                                              | The desired output format of the audio file (wav, mp3). Default is wav.                                         |
| `voice_settings`                                                                                                | [Optional[models.ConvertTextToSpeechParameters]](../../models/converttexttospeechparameters.md)                 | :heavy_minus_sign:                                                                                              | N/A                                                                                                             |
| `retries`                                                                                                       | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                                | :heavy_minus_sign:                                                                                              | Configuration to override the default retry behavior of the client.                                             |
