"""
Get Usage Statistics Example (Async)

This example demonstrates how to retrieve detailed usage statistics asynchronously.
Perfect for dashboard applications and monitoring systems.
"""
...
async def main():
    ...
    async with Supertone(api_key=api_key) as client:
        try:
            # Get usage statistics with pagination (async)
