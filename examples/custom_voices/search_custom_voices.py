"""
Search Custom Voices Example (Sync)

This example demonstrates how to search and filter your custom cloned voices
...
def main():
    ...
    with Supertone(api_key=api_key) as client:
        try:
            ...
            response = client.custom_voices.search_custom_voices(
                page_size=10,
            ...
            print("✅ Custom Voice Search Completed")
