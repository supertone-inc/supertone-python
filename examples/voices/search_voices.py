"""
Search Voices Example (Sync)

This example demonstrates how to search and filter voices based on various parameters
such as language, gender, age, use case, and style.
"""
